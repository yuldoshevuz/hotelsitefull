            ...
            <nav class="nav" id="nav">
                <div class="container">
                    <ul class="nav-items d-flex flex-column flex-md-row justify-content-md-between align-items-center">
                        ...
                        <li class="nav-item mt-4 mt-md-0"><a href="booking.html" class="nav-item__link">Bron qilish</a></li>
                        <li class="nav-item mt-4 mt-md-0"><a href="about.html" class="nav-item__link">Biz haqimizda</a></li>
                        <li class="nav-item mt-4 mt-md-0"><a href="rooms.html" class="nav-item__link">Xonalar</a></li>
                        <li class="nav-item mt-4 mt-md-0"><a href="facilities.html" class="nav-item__link">Ob'ektlar</a></li>
                        <li class="nav-item mt-4 mt-md-0"><a href="news.html" class="nav-item__link">Yangiliklar</a></li>
                        <li class="nav-item mt-4 mt-md-0"><a href="contacts.html" class="nav-item__link">Kontaktlar</a></li>
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-6 d-flex justify-content-end">
                            <h3 class="header-info__text text-end">
                                <a href="tel:+998555062424">+998 55 506 24 24</a>
                                </br>
                                <a href="tel:+998555024848">+998 55 502 48 48</a>
                            </h3>
